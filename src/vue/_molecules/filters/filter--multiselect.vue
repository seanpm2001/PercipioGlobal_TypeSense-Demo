...
<template>
    <fieldset>
        <legend class="border-b border-blue-500/20 w-full">
            <button 
                type="button" 
                class="font-primary flex w-full items-center justify-between px-2 py-3 text-gray-200 hover:text-gray-400" 
            ...
            >
                ...
                <span 
                    v-if="filter.counts.length > limit"
                    class="ml-6 flex items-center text-blue-500"
                >
        ...
        <span 
            ...
            class="font-primary text-sm text-gray-400 p-2 inline-block"
        >
            ...
            <div class="space-y-1.5">
                ...
                >
                    ...
                    >
                        ...
                        >
                        <span class="ml-3 min-w-0 flex-1 flex-1 text-gray-400">
